...
window.ChatbotManager = (function () {
  ...
  const STORAGE_KEY = 'alibaba_chat_history_v2';
...
Feel free to ask me about delivery vs pickup payouts, specific branches, menu best sellers, secondary basket pairings, or downtime causes!`;
  ...
  function init() {
    ...
    const fsNewChat = document.getElementById('fsNewChatBtn');
    ...
    if (fsNewChat) fsNewChat.addEventListener('click', clearConversation);
